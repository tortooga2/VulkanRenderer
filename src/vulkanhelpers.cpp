...
void VKHelpers::CreateSwapChain(GLFWwindow *&window, VkPhysicalDevice &physicalDevice, VkDevice &device, VkSurfaceKHR &surface, VkSwapchainKHR &swapChain, std::vector<VkImage> &swapChainImages, VkExtent2D &swapChainExtent, VkFormat &swapChainImageFormat)
{
...
void VKHelpers::CreateImageViews(VkDevice &device, std::vector<VkImageView> &swapChainImageViews, std::vector<VkImage> &swapChainImages, VkFormat &swapChainImageFormat)
{
...
void VKHelpers::CreateRenderPass(VkDevice &device, VkFormat &swapChainImageFormat, VkRenderPass &renderPass)
{
...
void VKHelpers::CreateGraphicsPipeline(VkDevice &device, VkExtent2D &swapChainExtent, VkPipelineLayout &pipelineLayout, VkRenderPass &renderPass, VkPipeline &graphicsPipeline)
{
...
void VKHelpers::CreateFramebuffers(VkDevice &device, std::vector<VkFramebuffer> &swapChainFramebuffers, VkRenderPass &renderPass, std::vector<VkImageView> &swapChainImageViews, VkExtent2D &swapChainExtent)
{
...
void VKHelpers::CreateCommandPool(VkDevice &device, VkCommandPool &commandPool, QueueFamilyIndices &indices)
{
...
VkExtent2D VKHelpers::ChooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities, GLFWwindow *&window)
{
